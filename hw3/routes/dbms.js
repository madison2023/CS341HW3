...
var host = "35.197.34.83";    //from GCloud instance (change to match your db)
var database = "cheesecakedb";  //database name
var user = "rcmadison26";         //username (change to match your db)
var password = "ilovecheesecake";  //password (change to match your db, yes this is very poor practice)
